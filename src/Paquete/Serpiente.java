...
public class Serpiente extends JPanel{
    ...
    int tamanoMax, can,res;
    public static int tam;
    
    List<int[]> snake = new ArrayList<>();
    int[] comida = new int[2];
    
    public static String direccion="de";
    
    String direccionProxima = "";
    
    Thread hilo;
    MovimientoContinuo camino;
    
    public Serpiente(int tamanoMax, int can){
        ...
        camino = new MovimientoContinuo(this);
