...
public class menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("JUEGO DE LA SERPIENTE");

        jLabel6.setFont(new java.awt.Font("Comic Sans MS", 0, 24)); // NOI18N
        jLabel6.setText("Dificultad");

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Paquete/SnakeIcon.png"))); // NOI18N
    ...
    public void Dificultad(){
        dificultad = (String)jComboBox2.getSelectedItem();
        
        switch(dificultad){
            case "Facil": intervalo=1-0.03; break;
            case "Normal": intervalo=1-0.06; break;
            case "Dificil": intervalo=1-0.09; break;
        }
    }
